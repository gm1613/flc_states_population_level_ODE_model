...
function f = flc_state_model_fluct(t,v,tc0,tcf,tex_flag,fluct_flag,vrn2_flag)
...
%% Setting current values of LSCD model variables 
VIN3 = v(7); %Spliced VIN3 concentration
vin3 = v(8); %Unspliced VIN3 concentration
L = v(9);   %Long term input to VIN3 transcription
